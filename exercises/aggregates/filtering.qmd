...
I think that true shooting should take into account games started. To be considered for the best true shooting percentage, a player starting at least the third quartile of all players is a good measure to show his importance for a team. True shooting percentage isn't neccesarily finding out which players are the best overall scorers. Rather, the stat is about finding the most efficient player in college basketball. I think adding a cutoff of 25 games started is a good measure of finding the most efficient players among the most impactful players for each team. 
